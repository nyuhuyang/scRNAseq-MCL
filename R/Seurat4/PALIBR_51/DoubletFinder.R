...
saveRDS(sweep.res_list,file = "output/MCL_SCT_51_20210724_sweep.res_list.rds")
sweep.res_list = readRDS(file = "output/MCL_SCT_51_20210724_sweep.res_list.rds")
...
saveRDS(object,file=paste0("data/MCL_SCT_51_20210724.rds"))

TSNEPlot.1(object, group.by = "Doublets",cols = c("red","orange","black"),raster=FALSE,
