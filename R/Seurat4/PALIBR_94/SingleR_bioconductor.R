...
if(reference == "MCL+blue_encode"){
    ...
    saveRDS(object = pred, file = "output/MCL_94_20230615_blueEncode_singleR_pred.rds")
}
...
if(reference == "MCL+azimuth_PBMC"){
    ...
    system.time(pred <- classifySingleR(sce[common,], trained))
    saveRDS(object = pred, file = "output/MCL_94_20230615_azimuth_MCL_singleR_pred.rds")
}
