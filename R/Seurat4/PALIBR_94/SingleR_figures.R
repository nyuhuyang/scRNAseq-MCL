...
if(reference == "MCL+blue_encode"){
    pred = readRDS("output/MCL_94_20230615_blueEncode_singleR_pred.rds")
    ...
    singlerDF$label1.blue_encode %<>% gsub("Eosinophils|Megakaryocytes|Mesangial cells|Neutrophils","other Myeloid cells",.)
...
if(reference == "MCL+azimuth_PBMC"){
    pred = readRDS("output/MCL_94_20230615_azimuth_MCL_singleR_pred.rds")
...
object$cell.types <- object$label1.blue_encode
object$cell.types.colors <- object$label1.blue_encode.colors

if(all(rownames(meta.data) == colnames(object))){
...
val <- c("#40A635","#FE8205","#8861AC","#E83C2D","#E6AB02", "#ff0000", "#6A3D9A",
         "#2055da", "#ADDFEE","#FDAC4F",
         "#A65628","#B3B3B3","#FDDAEC",
         "#1B9E77","#B3DE69","#F0027F",
         "#7570B3","#808080","#F2F2F2")
names(val) <- c("B cells",paste0("C",1:4),"Erythrocytes","HSC,progenitors",
